...
license: CC0-1.0
metadata:
  standard-version: "0.37.0"
---

# Project Bootstrap and Audit

The standard is one long reference file beside this one:
[references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.37.0.md](references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.37.0.md).
It is written to be read in ranges, never end to end.

1. Build its heading index first:
   `grep -n '^# \|^## ' references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.37.0.md`, run from this skill's
   directory.
