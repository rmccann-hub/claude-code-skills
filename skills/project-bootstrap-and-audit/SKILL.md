...
[references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.38.0.md](references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.38.0.md).
It is written to be read in ranges, never end to end.

1. Build its heading index first:
   `grep -n '^# \|^## ' references/PROJECT-BOOTSTRAP-AND-AUDIT-v0.38.0.md`, run from this skill's
   directory.
